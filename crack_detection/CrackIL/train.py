...
from data.dataset import CrackTarget
...
def train(args, model):
    ...
    train_dataset_source = CrackTarget(args = args, base_dir = args.source_dataset_path)
    val_dataset_source = CrackTarget(args = args, base_dir = args.source_dataset_path)
