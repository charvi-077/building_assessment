...
def train(args, model, model_old, discriminator):
    ...
    target_dataset = CrackSource(args = args, base_dir = args.source_dataset_path, split ='train')
    # val_dataset_old= CrackSource(args = args, base_dir = args.source_dataset_path, split ='val')
    train_dataset_old = CrackTargetNew(args = args, base_dir = args.target_dataset_path, base_dir_source = args.source_dataset_path)
    
    print("Target:", len(target_dataset))
    print("Train:", len(train_dataset_old))
    ...
    val_loader_old = DataLoader(train_dataset_old, batch_size=args.batch_size_val, shuffle=False, num_workers=4, pin_memory=True, drop_last=False)
    ...
    for epoch in range(start_epoch, args.num_epochs + 1):
        ...
        if i < 10:
            ...
            print("Validation after segmentation epoch")
