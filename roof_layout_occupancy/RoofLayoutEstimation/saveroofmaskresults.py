...
def SaveResult(image_path, roof_mask_path, save_path):
    ...
    result_path = os.path.join(save_path, image_path.replace('.jpg', '_roofresult.jpg'))

    # Save the result directly as an image using OpenCV
    cv2.imwrite(result_path, roof_mask)
