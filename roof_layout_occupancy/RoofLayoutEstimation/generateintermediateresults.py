...
def SaveResult(image_path, roof_mask_path, object_mask_path, save_path):
    ...
    result_path = os.path.join(save_path, image_path.replace('.png', '_combinedresult.png'))

    # Save the result images directly using OpenCV
    cv2.imwrite(result_path, image)
    cv2.imwrite(result_path.replace('_combinedresult.png', '_roof_mask.png'), roof_mask)
    cv2.imwrite(result_path.replace('_combinedresult.png', '_object_mask.png'), object_mask)
